...
<body>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="nome"><strong> Nome articolo </strong></label> <input
						type="text" class="form-control" id="nome" name="nome"><%=prodotto.getNome()%>
				</div>
				<br>
				<div class="form-group col-md-6">
					<label for="descrizione"><strong> Descrizione
							articolo</strong></label> <input type="text-area" class="form-control" id="text"
						name="descrizione"><%=prodotto.getDescrizione()%>
				</div>
			</div>
			<br>
			<div class="numeri">
				<div class=" form-group col-md-1 p-2">
					<label for="prezzo"><strong> Prezzo </strong></label> <input
						...
						placeholder="€" name="prezzo"><%=prodotto.getPrezzo()%>
				</div>
				<br>
				<div class=" form-group col-md-2 p-2">
					<label for="quantita"><strong>Quantità in
						...
						name="quantita"><%=prodotto.getQuantita()%>
				</div>
			</div>
			<br> <br> <br>
	...
	<%@ include file="FooterPriv.jsp" style="display:absolute;"%>
